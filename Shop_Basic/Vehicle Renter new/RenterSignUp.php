...
<div class="form">
<form method = "post" action="VehicleMenu.php" onsubmit="return Errorcheck()">
        ...
        <br>
        <input type="text" name="firstName" id="firstName" autocomplete="on" class="form-control" required>
        <br>
        <label for="lastName">Last Name:</label> 
        <br>
        <input type="text" name="lastName" id="lastName" autocomplete="on" class="form-control" required>
        <br>
        <br>
