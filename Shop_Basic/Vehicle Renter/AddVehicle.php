    ...
    <div class="wrapper">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <br>
                <textarea name="vehicleDetails" class="form-control" id="vehicleDetails" 
                    maxlength="1000" placeholder="Do not exceed more than 1000 characters"></textarea>
                <br>
            </div>
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                for($i=0;$i<count($file_array);$i++){
                    ...
                    if(!$file_array[$i]['error']){
                        ...
                        $directoryName = 'files/'.$user.'/'.$last_id."_".$model.'/';
