            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        Last Name:
                        <br>
                        <input type="text" class="form-control" name="lastName" id="lastName" autocomplete="on">
                        <br>
                        <br>
                        <div class="form-group">
                            <fieldset>
                                ...
                                Address:
                                <input type="text" class="form-control" name="address" id="address" size="75">
                                <br>
                                <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                                Location:
                                <button type="button" name="getLocation" onclick="unhideFunction()">get
                                    location</button>
                                                ...
                                                <div class="col-md-5 signupbox">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="number" step="any" id="Latitude"
                                                            name="shopLatitude" class="form-control" value="">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="number" step="any" id="Longitude"
                                                            name="shopLongitude" class="form-control" value="">
                                                    </div>
                                                    <div class="form-group">
                            ...
                            <fieldset>
                                ...
                                Email:
                                <input type="email" class="form-control" name="email" id="email" size="50">
                                <br>
                                Mobile:
                                <input type="text" class="form-control" name="mobile" id="mobile" size="20" placeholder="+94-*********"
                                    required>
                            </fieldset>
                            <br>
                            <input type="submit" class="btn btn-primary" name="insert" id="insert" value="Submit" />
